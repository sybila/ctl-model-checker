 ...
 */
class TierQueue<State>() : Iterable<Set<Pair<State, State?>>> {

    private val distance = HashMap<State, Int>().withDefault { Int.MAX_VALUE }
    ...
    fun add(item: State, from: State?) {
        ...
        val newDistance = distance[item] ?: Int.MAX_VALUE
