...
import com.github.sybila.checker.bindReference
import com.github.sybila.checker.distributed.channel.SingletonChannel
import com.github.sybila.checker.distributed.operator.*
import com.github.sybila.checker.distributed.partition.SingletonPartition
import com.github.sybila.checker.invertCardinality
import com.github.sybila.checker.isExistential
import com.github.sybila.checker.isNormalTimeFlow
                ...
                return tree.computeIfAbsent(key) {
                    ...
                    when (key) {
                        ...
                        is Formula.Bool<*> -> when (key as Formula.Bool<*>) {
                            ...
                            is Formula.Bool.Equals -> resolve((key.left and key.right) or (com.github.sybila.huctl.not(key.left) and com.github.sybila.huctl.not(key.right)))
                        }
